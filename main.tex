...
%***************Habitats & Wildlife**************
\chapter{Habitats and Wildlife}\label{sec:habitats}
\input{cornwall_tex/habitats}

%***************Water Resources******************
\chapter{Water Resources}\label{sec:water}
...
%**************References**********************
\chapter{References \& Resources}\label{sec:references}
\printbibliography
...
\glsaddall
\renewcommand{\glossarychapter}[2][]{}
\printglossary
...
\namedlabel{app:cornwall_species}{Known Species of Conservation Concern in the 
