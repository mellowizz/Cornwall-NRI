...
\includepdf[pages=-,fitpaper]{cornwall\_maps/AreasofKnownImportance.pdf}\label{map:aok}
...
past.
\includepdf[pages=-,fitpaper]{cornwall\_maps/ForestPatchesRegionalForestLinkageZones.pdf}\label{map:forestpatches}
...
\includepdf[pages=-,fitpaper]{cornwall\_maps/TidalWetlandsandSAV.pdf}\label{map:tidalwetlandsandSAV}
...
% 218?
\includepdf[pages=-,fitpaper]{cornwall\_maps/MeadowsGrasslandsandShrublands.pdf}~\label{map:meadowgrasslandsandshrublands}
