...
\subsection*{Why this habitat is important}
\begin{wrapfigure}{L}{10.2cm}
    \includegraphics[width=10cm, keepaspectratio]{images/bird.jpg}
  \caption{A bird}
\end{wrapfigure}
...
grasslands when they burned the land for agriculture and to imprve forage for
